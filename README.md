# `OpenPVSignal`: An Ontology Model Aiming to Advance Pharmacovigilance Signal Search, Sharing and Reuse via FAIR Data Principles and Semantic Web Technologies
